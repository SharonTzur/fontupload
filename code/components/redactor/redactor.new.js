            ...
            return {
                ...
                format                  : function (tag, type, value)
                {
                    ...
                    if (tag == "em")
                    {
                        tag = "span";
                        type = "style";
                        value = toolBarIcon.hasClass('redactor-act') ? "font-style:normal;" : "font-style:Italic;"
                    }
                    ...
                    if (tag == "strong")
                    {
                        tag = "span";
                        type = "style";
                        value = toolBarIcon.hasClass('redactor-act') ? "font-weight:normal;" : "font-weight:Bold;"
                    }
